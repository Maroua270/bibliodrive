...
// Protection (l'accès à cette page sera refusé si l'utilisateur n'est pas connecté)
...
// Protection (l'accès à cette page sera refusé si l'utilisateur n'est pas connecté en tant qu'administrateur)
