                    ...
                    <?php if (!empty($resultats)): ?>
                        <div class="list-group">
                            <?php foreach ($resultats as $livre): ?>
                                <a href="livre.php?id=<?= (int)$livre['nolivre'] ?>" class="list-group-item list-group-item-action">
                                    <h5 class="mb-1"><?= htmlspecialchars($livre['titre']) ?></h5>
                                    <p class="mb-0 text-muted">par <?= htmlspecialchars($livre['prenom'] . ' ' . $livre['nom']) ?></p>
                                </a>
                            <?php endforeach; ?>
                        </div>
                    <?php endif; ?>
